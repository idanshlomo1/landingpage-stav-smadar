            ...
            <div className='grid gap-4 grid-cols-1 md:grid-cols-1 lg:grid-cols-2 mt-4 max-w-[1200px] mx-auto'>
                ...
                <div   data-aos="fade-down"
                    ...
                    <p className="text-2xl flex-1 md:text-2xl font-bold mt-4">
                        להימנע מסיסמאות ותוכן לעוס -
                        <span className='text-secondary'>אנחנו באים לדבר תכלס</span>
                ...
                <div   data-aos="fade-down"
                    ...
                    <p className="text-2xl flex-1 md:text-2xl font-bold mt-4">
                        ...
                        <span className='text-secondary'>תוכן ייחודי ואיכותי חזק יותר מאפקטים </span>
